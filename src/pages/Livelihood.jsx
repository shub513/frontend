...
import livelihood from "../assets/livelihood.png";
...
const stats = [
    ...
    { value: 15097, label: "Lives impacted" },
    { value: 280, suffix: "M", label: "Investments raised (INR)" },
...
const Livelihood = () => {
    ...
    return (
        <section className="overflow-hidden bg-white">
            <div
                ref={ref}
                className="relative h-[480px] bg-cover bg-center bg-no-repeat max-md:h-[520px] max-md:bg-bottom"
                style={{
                    backgroundImage: `url(${livelihood})`,
                }}
            >
                <div className="mx-auto flex min-h-[620px] max-w-7xl items-start px-6 pb-28 pt-24 md:px-10 md:pb-36 md:pt-36 max-md:min-h-[430px] max-md:pb-12 max-md:pt-12">
                    <div className="max-w-[42rem]">
                        <motion.h1
                            ...
                            custom={0}
                            className="font-boska text-[4rem] leading-[0.95] text-white md:text-[50px] pb-2 font-bold max-md:max-w-[17rem] max-md:text-[3rem]"
                        >
                        ...
                        >
                          Nurturing inclusion, empowerment and diversity at every step.
                        </p>
                    </div>
            ...
            <div className="bg-white px-6 pb-20 pt-8 md:px-10 md:pb-24  md:pt-10">
                <div className="mx-auto max-w-5xl">
                    <div className="grid grid-cols-2 gap-x-8 gap-y-12 text-center md:grid-cols-4 md:gap-x-18">
                        {stats.map((item, i) => (
                            <motion.div
                                key={item.label}
                                variants={fadeUp}
                            ...
                            >
                                <h2
                                    className="leading-none text-[#AF4AFE] md:text-[36px] max-md:text-[42px]"
            ...
            <div ref={actionRef} className="bg-white  pb-24  ">
                <div className="h-[400px] w-[100%] sm:px-10 md:px-16 md:py-20 lg:rounded-t-[8rem] max-md:h-auto max-md:px-4 max-md:py-10">
                    <motion.h2
                        variants={fadeSlide}
                        initial="hidden"
                    ...
                    <motion.p
                        ...
                        animate={actionInView ? "visible" : "hidden"}
                        custom={1}
                        className="mx-auto mt-6 max-w-6xl text-center font-sans text-[20px] leading-[1.65] text-[#2f405f] md:text-[20px] max-md:text-[16px]"
                    >
                       

                        We work with startups that <span className="font-bold"> generate livelihood opportunities for women in rural communities.</span> We extend support to women-led startups in agriculture and climate action, and approach inclusive livelihoods & entrepreneurship from two angles
                    </motion.p>

                    <div className="mt-16 grid gap-10 px-[100px] lg:grid-cols-2 lg:gap-16 max-md:mt-8 max-md:px-0">
                            ...
                            return (
                                ...
                                >
                                    <motion.div
                                        ...
                                        className="flex h-24 w-24 shrink-0 items-center justify-center rounded-full bg-[#AF4AFE] shadow-[0_14px_32px_rgba(17,173,212,0.18)]"
                                    >
                                        <img
                                            src={item.image}
                                            alt={item.title}
                            ...
                            return (
                                <motion.article
                                    ...
                                    className={`group relative h-[305px] overflow-hidden rounded-[30px] border px-9 pb-8 pt-5 transition-all duration-500 hover:shadow-[0_22px_44px_rgba(24,34,44,0.18)] max-md:h-auto max-md:min-h-[280px] max-md:cursor-pointer ${
                                        item.featured
                                            ? "border-[#AF4AFE] bg-black text-black "
                                            : isActiveMobileCard
                                            ? "border-[#AF4AFE] bg-[#AF4AFE] text-white shadow-[0_22px_44px_rgba(24,34,44,0.18)]"
                                            : "border-[#ece7db] bg-white text-[#111111] shadow-[0_14px_34px_rgba(18,28,45,0.14)] hover:border-[#AF4AFE] hover:bg-[#AF4AFE] hover:text-white"
                                    }`}
                                >
                                            ...
                                            <div
                                                className={`flex h-18 w-18 items-center justify-center rounded-full transition-all duration-500 group-hover:scale-100 group-hover:rotate-3 ${
                                                    item.featured
                                                        ...
                                                        : isActiveMobileCard
                                                        ? "bg-white text-[#AF4AFE]"
                                                        : "bg-[#f3eadf] text-[#4a4a4a] group-hover:bg-white group-hover:text-[#AF4AFE]"
                                                }`}
                                            >
            ...
            <div className="bg-[#fbf7e7] px-6 pb-28 pt-20 md:px-10 md:pb-32">
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="mt-16 grid gap-10 md:grid-cols-2 xl:grid-cols-3">
                        {programCards.map((card, index) => {
                            ...
                            <article
                                ...
                                className={`group overflow-hidden rounded-[32px] bg-white text-[#1d1d1d] transition-all duration-500 hover:border-transparent hover:bg-[#AF4AFE] max-md:cursor-pointer ${
                                    isActiveProgramCard ? "bg-[#AF4AFE] text-white" : ""
                                }`}
                            >
                                ...
                                <div className={`space-y-4 px-6 py-7 transition-colors duration-500 ${isActiveProgramCard ? "bg-[#AF4AFE]" : "group-hover:bg-[#AF4AFE]"}`}>
                    ...
                    <div className="mt-12 flex justify-center">
                         ...
                         <button
                            type="button"
                            className="rounded-full bg-[#ebe0b8] px-8 py-4 text-[18px] text-[#1e1e1e] shadow-[0_8px_18px_rgba(60,52,30,0.08)] transition-all duration-300 hover:bg-[#AF4AFE] hover:text-white md:px-12 md:text-[13px]"
                        >
                            View All {"->"}
                        </button>
                    </div>
            ...
            <div className="bg-white px-6 pb-28 pt-20 md:px-10 md:pb-32">
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="mt-16 grid gap-6 sm:grid-cols-2 xl:grid-cols-5">
                        {donorLogos.map((donor, index) => {
                            ...
                            <div
                                ...
                                className={`flex h-[150px] items-center justify-center rounded-[28px] border border-[#ece7db] bg-white px-6 text-center shadow-[0_10px_30px_rgba(15,20,32,0.04)] transition-all duration-300 hover:bg-[#AF4AFE] hover:text-white max-md:cursor-pointer ${
                                    isActiveDonorCard ? "bg-[#AF4AFE] text-white" : ""
                                }`}
                            >
                    ...
                    <div className="mt-14 flex justify-center">
                        <button
                            type="button"
                            className="rounded-full bg-[#ebe0b8] px-10 py-4 text-[16px] font-semibold text-[#1e1e1e] shadow-[0_12px_28px_rgba(60,52,30,0.12)] transition-all duration-300 hover:bg-[#AF4AFE] hover:text-white"
                        >
                            View All {"->"}</button>
                    </div>
                </div>
                        ...
                        {resourceTabs[activeTab].map((item, index) => {
                            ...
                            >
                                <div className={`relative overflow-hidden rounded-[32px] bg-white shadow-[0_24px_56px_rgba(15,20,32,0.08)] transition-all duration-500 ${isActiveResourceCard ? "shadow-[0_28px_64px_rgba(15,20,32,0.12)]" : "group-hover:shadow-[0_28px_64px_rgba(15,20,32,0.12)]"}`}>
                                    ...
                                    <div className={`absolute inset-0 flex items-center justify-center transition-all duration-500 ${isActiveResourceCard ? "bg-[#AF4AFE]/80 opacity-100" : "bg-[#2FA4FF]/0 opacity-0 group-hover:bg-[#AF4AFE]/80 group-hover:opacity-100"}`}>
                                        <button
                                            type="button"
                                            onClick={(event) => {
